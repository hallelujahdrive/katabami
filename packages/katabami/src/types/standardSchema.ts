...
export declare namespace StandardSchemaV1 {
	...
	/** Katabami-specific options passed via Standard Schema `libraryOptions`. */
	export interface LibraryOptions extends Record<string, unknown> {
		/** Custom formatter for validation issue messages. */
